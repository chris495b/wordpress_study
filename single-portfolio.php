    ...
    <div class="container">
      <div class="page-header">
        <div class="row">
            ...
            <div class="col-xs-3 prev-next">
              ...
              <a href="<?php bloginfo('url')?>/?p=100"><span class="glyphicon glyphicon-th"></span></a>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          ...
          <?php the_content(); ?>
          <p>
            <a class="btn btn-large btn-primary" href="<?php the_field('link'); ?>" >Vliew Final Piece <span class="glyphicon glyphicon-arrow-right"></span></a>
          </p>
        </div>
